...
- `examples/v0.5/resonator_basics.py`：理想 notch、IQ circle、频移和 fixed-tone IQ 响应；
- `examples/v0.5/resonator_fit_demo.py`：加入 complex gain、cable delay、asymmetry 和噪声，拟合回 resonance 参数。
...
- v0.5：$Q_i/Q_c/Q_r$、notch resonator、IQ circle、固定 tone 读出与实际 fitting
