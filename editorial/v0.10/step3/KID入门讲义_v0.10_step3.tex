...
\hypersetup{colorlinks=true,linkcolor=KidBlue,urlcolor=KidBlue,citecolor=KidTeal,pdftitle={KID入门讲义 v0.10 Step 3 Editorial Preview},pdfauthor={KID Intro Guide project}}
\setstretch{1.15}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{KID 入门讲义 v0.10 Step 3 Editorial Preview}
...
\vspace{1.4cm}
{\large Version 0.10 Step 3 Editorial Preview · 2026-09-10}\par
\vfill
