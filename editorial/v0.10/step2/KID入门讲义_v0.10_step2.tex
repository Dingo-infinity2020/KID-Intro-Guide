...
\hypersetup{colorlinks=true,linkcolor=KidBlue,urlcolor=KidBlue,citecolor=KidTeal,pdftitle={KID入门讲义 v0.10 Step 2 Preview},pdfauthor={KID Intro Guide project; editorial preview}}
\setstretch{1.15}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{KID 入门讲义 v0.10 Step 2 Preview}
...
\begin{tabularx}{\textwidth}{>{\bfseries\color{KidBlue}}p{3.0cm} X}
为什么要学？ & #1 \\
阅读前只需要知道 & #2 \\
读完应能回答 & #3 \\
一句话结论 & \textbf{#4} \\
...
% --- Flow-chart conventions (v0.2+, retained in v0.3) ---
...
\vspace{1.4cm}
{\large Version 0.10 Step 2 Preview · 2026-09-09}\par
\vfill
