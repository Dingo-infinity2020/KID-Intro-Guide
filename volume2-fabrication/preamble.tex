...
\hypersetup{colorlinks=true,linkcolor=KidBlue,urlcolor=KidBlue,citecolor=KidTeal,pdftitle={KID 器件加工与实验入门 v0.2},pdfauthor={KID Intro Guide project}}
\setstretch{1.15}
\setlength{\parindent}{2em}
\setlength{\parskip}{0.25em}
% Bilingual technical prose can contain long English compounds. Give TeX a
% controlled last-resort stretch before it creates an overfull line.
